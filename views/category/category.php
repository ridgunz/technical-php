            ...
            <div class="white-box">
              ...
              <div class="table-responsive">
                <table class="table text-nowrap">
                  ...
                  <tbody>
                    <?php foreach ($category as $index => $categorys): ?>
                      <tr>
                        <td>
                          <?php echo $index + 1; ?>
                        </td>
                        ...
                        <td>
                          <button type="button" class="btn btn-warning" data-toggle="modal"
                            data-target="#editModal<?php echo $categorys['id']; ?>">
                            Edit
                          </button>

                          <a href="../../function/category/delete_category.php?action=delete&id=<?php echo $categorys['id']; ?>"
                      ...
                      <!-- Modal for Edit -->
                      <div class="modal fade" id="editModal<?php echo $categorys['id']; ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              ...
                              <form action="../../function/category/edit_category.php" method="POST">
                                <input type="hidden" name="id" value="<?php echo $categorys['id']; ?>">
                                <label for="editName">Name:</label>
                                <input type="text" name="editName" value="<?php echo $categorys['category_name']; ?>"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="../../function/category/add_category.php" method="POST">
